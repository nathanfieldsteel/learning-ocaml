...
#+begin_src ocaml :results verbatim
        ...
        let multiply_matrices m1 m2 =
          ...
          (* have m1 and transposed m2. Need to take the (outer) product of these lists with dot and put the results in an output matrix. Work on this later*)
          m1 (transpose m2);;

        multiply_matrices [[0;1];[2;3]] [[4;5];[6;7]]
#+end_src
